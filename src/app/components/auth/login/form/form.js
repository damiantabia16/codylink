        ...
        <div className="p-5">
            <div className="flex flex-col justify-center w-[350px] mx-auto space-y-6">
                ...
                <div className="flex flex-col space-y-2 text-center">
                    <h1 className="font-bold text-2xl tracking-tight">Ingresar</h1>
                    <p className="text-sm text-[#888]">Ingresa tu email y contraseña para ingresar</p>
                </div>
                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-1">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    autoCapitalize="none"
                                    className="flex w-full h-[2.25rem] border border-[#888] rounded-lg bg-transparent py-1 px-3 text-sm" />
                            </div>
                            <div className="grid gap-1">
                            ...
                            <button className="bg-[#3872ab] rounded-lg py-2 px-4 text-sm transition-all ease-in-out hover:bg-[#3872ab]/90">Iniciar sesión</button>
                        </div>
                    </form>
